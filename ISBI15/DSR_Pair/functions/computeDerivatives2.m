...
dx1 = conv2sep(im1,dfilter,filter,'same');
dy1 = conv2sep(im1,filter,dfilter,'same');
blur1 = conv2sep(im1,filter,filter,'same');
dx2 = conv2sep(im2,dfilter,filter,'same');
dy2 = conv2sep(im2,filter,dfilter,'same');
blur2 = conv2sep(im2,filter,filter,'same');
