...
function [res, im_int]=mirt2D_register_rigid(refim, im, main, optim)
...
% tic
% disp('MIRT: Starting 2D B-spline based registration.');
...
if isfield(main,'initialX')
    Minitial = main.initialX;
end
...
%     
    ...
    % Choose Translation
%     if(main.type(1) == 'T')
   [M,result] = mirt2D_registration_rigid(ima1,ima2,main,optim);
%     end
