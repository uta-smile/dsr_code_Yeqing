...
function [  UwImgs, alignedImgs, unalignedImgs, outliers ,Tau_out] = tgrasta_batch_training2( I, OPTIONS, AlignPara )
...
for i=1:numtrainingImages,
    init_tau = AlignPara.init_trans{i}; 
    init_tau = [init_tau; 0 0 1];
