...
OPTIONS.MAX_OUTER_LOOP      = 15; % If we train the initial clean subspace, should be large enough! 

% simple online model
OPTIONS.MAX_ALIGN_LOOP      = 20; 
