function [D, Do, A, E, xi, numIterOuter, numIterInner ] = dsr_main2(I,Iori, transformations, numImages, raslpara, destDir)
...
%         Iori0{scaleIndex,fileIndex} = currentImagePyramid{scaleIndex};
...
%             [A, E, delta_xi, numIterInnerEach] = rasl_inner_ialm2(D, Q, lambda, raslpara.inner_tol, raslpara.inner_maxIter);
...
if raslpara.saveEnd
    save(fullfile(destDir, 'finalDSR.mat'),'Do','A','E','xi') ;
end
