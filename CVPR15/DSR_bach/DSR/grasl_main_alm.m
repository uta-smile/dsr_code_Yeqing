function [Din, Do, A, E, xi, numIterOuter, numIterInner ] = grasl_main_alm(I,Iori, transformations, numImages, raslpara, destDir)
...
if raslpara.saveEnd
    save(fullfile(destDir, 'finalgrasl.mat'),'Do','A','E','xi') ;
end
