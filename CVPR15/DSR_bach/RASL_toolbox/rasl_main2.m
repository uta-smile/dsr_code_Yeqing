function [Din, Do, A, E, xi, numIterOuter, numIterInner ] = rasl_main2(I,transformations, numImages, raslpara, destDir)
...
%              [A, E, delta_xi, numIterInnerEach] = dsr_inner(D, Q, lambda, raslpara.inner_tol, raslpara.inner_maxIter,imgSize);
        end
        for fileIndex = 1 : numImages
